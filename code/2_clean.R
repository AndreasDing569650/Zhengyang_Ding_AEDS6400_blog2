movie_raw <- read.csv(
  "D:/Rproject/6400-blog2/data_scraped.csv",
  header = TRUE,
...
movie_raw$Gener <- gsub("[^\\p{Han}]", "", movie_raw$Gener, perl = TRUE)
unique(movie_raw$Gener)
genre_code <- c(
  "犯罪" = "Crime",
  "剧情" = "Drama",
  "喜剧" = "Comedy",
...
movie_raw$Gener <- unname(genre_code[movie_raw$Gener])
